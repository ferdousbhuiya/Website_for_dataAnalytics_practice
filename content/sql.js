...
const sqlData = {
    ...
    ,
    {
        ...
        "content": "<h4>1. SQL JOINs Visualized</h4>\n\n<p>How the four JOIN types slice two tables. A JOIN combines rows from two tables by a key.</p>\n\n```mermaid\n\nflowchart LR\n\n    A[CUSTOMERS] -- INNER --> B[Only rows in both tables]\n\n    A -- LEFT --> C[All customers + matches]\n\n    D[ORDERS] -- RIGHT --> E[All orders + matches]\n\n    A -- FULL OUTER --> F[Everything both sides]\n\n```\n\n<h4>2. When to use which</h4>\n\n<ul>\n\n<li><strong>INNER JOIN:</strong> rows in both tables.</li>\n\n<li><strong>LEFT JOIN:</strong> all left rows + matches.</li>\n\n<li><strong>RIGHT JOIN:</strong> all right rows + matches.</li>\n\n<li><strong>FULL OUTER:</strong> all rows, NULL unmatched.</li>\n\n</ul>"
    }
],
        questions: [
            {
