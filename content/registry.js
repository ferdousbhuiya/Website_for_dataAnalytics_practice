...
const topicRegistry = {
    order: [
        // Core
        'python_setup', 'python', 'statistics', 'communication', 'experiment_design',
        // Data Analyst
        ...
        'etl_project', 'cloud_project',
        // Data Scientist
        'machine_learning', 'statistical_modeling', 'deep_learning',
        // Data Scientist — Projects
        'ml_project', 'stats_project', 'oop_project'
    ],
    tracks: TRACKS,
    topics: {
        // ---- Core ----
        python_setup:      { track: 'core', category: 'Setup', color: '#4facfe', icon: '🚀', description: 'Start Python: Google Colab, VS Code, venv, requirements.txt, first code' },
        ...
        product_project:   { track: 'data-analyst', category: 'Project', color: '#667eea', icon: '🚀', description: 'Product analytics deep dive: funnels, cohorts, aha moment' },
        ...
        cloud_project:     { track: 'data-engineer', category: 'Project', color: '#f43f5e', icon: '☁️', description: 'Cloud data warehouse migration project' },
        ...
        oop_project:         { track: 'data-scientist', category: 'Project', color: '#f472b6', icon: '⚙️', description: 'Python OOP data-pipeline library project' }
    }
};
