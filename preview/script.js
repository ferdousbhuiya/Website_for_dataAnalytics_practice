// DataPrep Pro preview bootstrap v17: Intermediate stage + applied learning engine.
(function(){
  var VERSION='17';
  ...
  [
    ...
    ['final-beginner-ui.css','finalBeginnerUITheme'],['intermediate-stage-flow.css','intermediateStageTheme'],['intermediate-learning-engine.css','intermediateLearningTheme']
  ].forEach(function(x){loadCss(x[0],x[1])});
  loadScript('etl-routing-guard.js','data-etl-routing-guard');loadScript('practice-system-v3.js','data-practice-system-v3');loadScript('subject-tabs-v1.js','data-subject-tabs-v1');loadScript('final-beginner-ui.js','data-final-beginner-ui');loadScript('beginner-navigation-fix.js','data-beginner-navigation-fix');
