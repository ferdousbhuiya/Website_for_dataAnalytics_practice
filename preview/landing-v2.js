(function(){
 ...
 <section class="lv2-dashboard">
   ...
   <div class="lv2-dashboard-actions" aria-label="Learning actions"><button type="button" class="lv2-primary" data-lv2-start>Start / Continue Learning <b>→</b></button><button type="button" class="lv2-secondary" data-hldb-open>Higher-Level Database &amp; SQL <b>↗</b></button><button type="button" class="lv2-secondary" data-bd-career-open>Career Goal &amp; Roadmap <b>◎</b></button></div>
 </section>
